...
//        System.out.println("Starting position at the call of getRR: " + buffer.position());
        String cname;
        String mxname;
        String nsname;
        byte[] rdata;
...
//            System.out.println("In rtype: AAAA");
            rdata = new byte[16];
...
//            System.out.println("In rtype: CNAME");
            cname = getName();
...
//        System.out.println("Rdatalen: " + rdatalen);
