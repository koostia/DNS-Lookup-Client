...
public class DNSLookupServiceTest {
    ...
    private void checkRRs(Collection<ResourceRecord> rrs) {
        for (ResourceRecord rr : rrs) {
            ...
            System.out.println("Hostname of question: " + question.getHostName());
            List<ResourceRecord> results = cache.getCachedResults(question);
            System.out.println("Cache Results Size: " + results.size());
    ...
    public void testSend() {
        ...
        try {
            ...
            Set<ResourceRecord> s = service.individualQueryProcess(question, server);
